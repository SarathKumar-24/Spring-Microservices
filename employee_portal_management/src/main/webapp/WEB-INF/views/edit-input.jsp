...
<body>
<h1 align="center">Add/Update Employee Record</h1>
	<form:form action="/input" method="post"
		...
		<table>
			...
			<tr>
				<td>Employee No# (*)</td>
				<td><form:input path="empId" placeholder="Enter Employee #" disabled="true"/></td>
			...
			<tr>
				...
				<td><form:button type="reset">Cancel</form:button>
				</td>
			</tr>
		</table>
		</div>
	</form:form>
	<div align="center"><button onclick="window.location.href='/home'">Back to Home</button></div>
</body>
</html>